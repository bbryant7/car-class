...
// model, doors, color, engineType, transmission, trim, wheelsTrim, audio, seatTrim, moonRoof, warranty
class Car extends Factory {
  constructor (model, doors, color, engineType, transmission, trim, wheelTrim, audio, seatTrim, moonRoof, warranty){
    super();
    this.model = model;
    this.doors = doors;
    this.color = color;
...
class Sport extends Car {
  constructor(model, trim, transmission, top, color, seatTrim, audio, wheelTrim){
    super(model, trim, transmission, top, color, seatTrim, audio, wheelTrim);
    this.top = top;
    this.doors = 2;
    this.moonRoof = false;
...
class Truck extends Factory {
  constructor (model, color, engineSize, trim, hitch, bed, navigation){
    super();
    this.model = model;
    this.color = color;
    this.engineSize = 4;
...
let miataRf = new Sport ("Miata-RF",  "leather", "manuel", "hardtop","red", "Grand touring", "premium", "premium");
...
let trailBlazer = new Truck ("Trail Blazer", "Red", "8", "Sport","true", "standard", "true", "2");
