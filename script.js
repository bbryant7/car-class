...
// Write your code below:
  ...
  // super(model, doors, trim, transmission, top, color, seatTrim, audio, wheelTrim);
let miataRf = new Sport ("Miata-RF",  "red","manual","Grand touring",  "hardtop", "premium", "leather", "premium");
